...
const panda = () => {
    ...
    const mainGroup = [{ name: "🌌 科学上网 | PANDA", type: "select" },];
    const ruleRequiredGroups = [
        { name: "🌠 规则逃逸", type: "select", proxies: ["🌌 科学上网 | PANDA", "DIRECT",] },
        { name: "🌆 数据下载 | IDM", type: "select", proxies: ["DIRECT", "🌌 科学上网 | PANDA"] },
        { name: "🌄 特殊控制 | OpenAI", type: "select", proxies: ["REJECT"], append: /.+/gmi },
        { name: "🌄 特殊控制 | Gemini", type: "select", proxies: ["REJECT"], append: /.+/gmi },
        { name: "🌄 特殊控制 | Copilot", type: "select", proxies: ["🌌 科学上网 | PANDA", "DIRECT"] },
    ];
    const mainRequiredGroups = [
        { name: "🌃 负载均衡 | Hong Kong", type: "load-balance", proxies: [], append: /🇭🇰.*x$/gmi },
        ...
        { name: "🌃 负载均衡 | Russia", type: "load-balance", proxies: [], append: /🇷🇺/gmi },
    ...
    const originalRules = [
        ...
        "RULE-SET,private,DIRECT",
        "RULE-SET,direct,DIRECT",
        "RULE-SET,greatfire,🌌 科学上网 | PANDA",
        "RULE-SET,gfw,🌌 科学上网 | PANDA",
        "RULE-SET,proxy,🌌 科学上网 | PANDA",
        "RULE-SET,tld-not-cn,🌌 科学上网 | PANDA",
        "RULE-SET,reject,REJECT",
        "RULE-SET,telegramcidr,🌌 科学上网 | PANDA,no-resolve",
        "RULE-SET,lancidr,DIRECT,no-resolve",
        "RULE-SET,cncidr,DIRECT,no-resolve"
    ];
    const endRules = [
