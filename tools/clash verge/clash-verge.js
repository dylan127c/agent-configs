...
const nebulae = () => {
    ...
    const groups = [
        ...
        { name: "🌃 故障转移 | HK-A", type: "fallback", proxies: [], append: /香港\s(帕|阿|波)/gm, reverse: /香港/gm },
        { name: "🌃 故障转移 | HK-B", type: "fallback", proxies: [], append: /香港\s(海|希|传)/gm, reverse: /香港/gm },
